...
You also have the option of adding a running a [data prepation step](env_setup/data_prep_seed_shared_disk_pd.sh) to the data pre-perations script before copying the data to the shared persistant disk.


## 2. Configuring the enviroment to train RoBERTa 
