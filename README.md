...
Click on the LINK generated by a succesfull deployment to access Jupyter Lab Notebook and use the generated PASSWORD to access the Jupyter lab. Navigate to the notebook called `PyTorch_RoBERTa_CloudTPU.ipynb`
